...
4. **Recursive feedback** - Feedback is important. I always build a tight iterative loop where users use the product, give feedback, and that feedback gets incorporated as quickly as possible (as GitHub issues or Linear issues, etc.).
